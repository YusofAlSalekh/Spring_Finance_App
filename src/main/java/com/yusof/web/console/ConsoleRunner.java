...
public class ConsoleRunner implements CommandLineRunner {
    ...
    private void changeAccountName(int clientId) {
        ...
        } catch (UnauthorizedException | AlreadyExistsException | NotFoundException | IllegalOwnerException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private void createNewAccount(int clientId) {
        ...
        } catch (UnauthorizedException | AlreadyExistsException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private void deleteAccount(int clientId) {
        ...
        } catch (UnauthorizedException | OperationFailedException | IllegalOwnerException | NotFoundException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private void getInformationByIncome(int clientId) {
        ...
        try {
            ...
            System.out.println("Error while getting information about your income");
        }
    }
    ...
    private void getInformationByExpense(int clientId) {
        ...
        try {
            ...
            System.out.println("Error while getting information about your expenses");
        }
    }

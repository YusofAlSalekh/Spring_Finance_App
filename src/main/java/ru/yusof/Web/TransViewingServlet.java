...
public class TransViewingServlet extends HttpServlet {
    private final TransactionService transactionService;

    public TransViewingServlet() {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (userId == null) {
            ...
            List<TransactionDTO> transactions = transactionService.showTransactions(userId);

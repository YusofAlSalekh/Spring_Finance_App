...
public class TransCatUpdatingServlet extends HttpServlet {
    private final TransactionCategoryService transactionCategoryService;

    public TransCatUpdatingServlet() {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (userId == null) {
            ...
            boolean updatedTransCat = transactionCategoryService.editTransactionCategory(newName, transactionCategoryId, userId);

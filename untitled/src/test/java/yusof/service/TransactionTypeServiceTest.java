...
class TransactionTypeServiceTest {
    ...
    void ReportOverExpensesDoesntWork() {
        when(transactionTypeDao.fetchExpenseByCategory(1, LocalDate.parse("2024-05-25"), LocalDate.parse("2024-05-30"))).thenThrow(new CustomException("The expense report failed to be displayed"));

        assertThrows(CustomException.class, () -> subj.getExpenseReportByCategory(1, LocalDate.parse("2024-05-25"), LocalDate.parse("2024-05-30")), "The expense report failed to be displayed");
    ...
    void ReportOverIncomeDoesntWork() {
        when(transactionTypeDao.fetchIncomeByCategory(1, LocalDate.parse("2024-05-25"), LocalDate.parse("2024-05-30"))).thenThrow(new CustomException("The income report failed to be displayed"));

        assertThrows(CustomException.class, () -> subj.getIncomeReportByCategory(1, LocalDate.parse("2024-05-25"), LocalDate.parse("2024-05-30")), "The income report failed to be displayed");
